    ...
    <nav class="navbar" :class="{ 
        ...
        <div class="navbar__container">
            ...
            <ul class="navbar__menu" :class="{ 'navbar__menu--open': isMenuOpen && !isDesktop }" role="menubar">
                <li v-for="project in projects" :key="project.slug" role="none">
                    <router-link :to="`/proyecto/${project.slug}`" class="navbar__link"
                        :class="{ 'navbar__link--active': activeSection === project.slug }" role="menuproject"
                        @click="closeMenu">
                        {{ project.slug }}
                    </router-link>
                </li>
