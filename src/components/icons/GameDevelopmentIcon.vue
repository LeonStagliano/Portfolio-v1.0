<template>
    <svg viewBox="-8.08 -8.08 96.95 96.95" xmlns="http://www.w3.org/2000/svg" fill="var(--main-color)" stroke="var(--main-color)"
        stroke-width="0.0008079000000000001">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC"
            stroke-width="0.16158"></g>
                        ...
                        <g id="Group_32" data-name="Group 32">
                            <g id="Group_31" data-name="Group 31">
                                ...
                                <path id="Path_75" data-name="Path 75"
                                    d="M303.15,433.021a3,3,0,1,1-4.24,0A3.1,3.1,0,0,1,303.15,433.021Z" fill="var(--main-color)">
                                </path>
                                ...
                                <path id="Path_78" data-name="Path 78"
                                    d="M298.15,438.021a3,3,0,1,1-4.24,0A3.1,3.1,0,0,1,298.15,438.021Z" fill="var(--main-color)">
                                </path>
                                <path id="Path_79" data-name="Path 79"
                                    d="M294.03,435.142a3,3,0,1,1-5.12-2.121,3.1,3.1,0,0,1,4.24,0A3.013,3.013,0,0,1,294.03,435.142Z"
                                    fill="var(--main-color)"></path>
                                <path id="Path_80" data-name="Path 80"
                                    d="M269.03,432.142a3,3,0,0,1,0,6h-2a3,3,0,0,1,0-6Z" fill="var(--main-color)"></path>
                                <path id="Path_81" data-name="Path 81"
                                    d="M265.53,440.142v2a3,3,0,0,1-6,0v-2a3,3,0,0,1,6,0Z" fill="var(--main-color)"></path>
                                <path id="Path_82" data-name="Path 82"
                                    d="M265.53,428.142v2a3,3,0,0,1-6,0v-2a3,3,0,0,1,6,0Z" fill="var(--main-color)"></path>
